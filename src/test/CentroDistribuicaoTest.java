...
public class CentroDistribuicaoTest {
  ...
  @ParameterizedTest
  @CsvSource({
      "500,10000,1250,1250,8000,400,4400,250,250",
      "250,4000,625,625,2000,50,2600,375,375",
  })
  ...
  // @CsvSource({
  //   "500,10000,1250,1250,7650,118,4645,294,294",
  //   "250,4000,625,625,2000,200,3300,500,500",
  //   "249,10000,1250,1250,8000", // Aditivo sobraviso -- add resto
  //   "500,4999,1250,1250,14286", // Gasolina sobraviso
  //   "500,10000,624,624,10000", // Alcool sobraviso
  // })
  ...
  // // add teste sobreviso - estrategico
